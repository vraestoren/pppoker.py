...
class PPPoker:
	...
	def _get(self, base: str, endpoint: str, params: dict = None) -> dict:
		return self.session.get(
			f"{base}{endpoint}", params=params or {}).json()
	...
	def register(self, username: str, password: str) -> dict:
		...
		return self._get(
			self.public_api, "/poker/api/register.php", params)
	...
	def get_verification_code(
		...
		return self._get(
			self.public_api, "/poker/api/mail/send_valid_code.php", params)
	...
	def get_portraits(self) -> dict:
		...
		return self._get(
			self.public_api, "/poker-api/portrait/list", params)
	...
	def get_user_invite_code(self) -> dict:
		...
		return self._get(
			self.public_api, "/server_api/user_invite/code", params)
	...
	def get_user_tasks(self) -> dict:
		...
		return self._get(
			self.public_api, "/server_api/new_user_task/tasks", params)
	...
	def link_email(self, email: str, code: int) -> dict:
		...
		return self._get(
			self.public_api, "/poker/api/mail/valid_mail.php", params)
	...
	def unlink_email(self, email: str, password: str) -> dict:
		...
		return self._get(
			self.public_api, "/poker/api/mail/unlink_mail.php", params)
	...
	def change_password(
		...
		return self._get(
			self.public_api, "/poker/api/mail/change_pw.php", params)
	...
	def check_username(self, username: str) -> dict:
		...
		return self._get(
			self.public_api, "/poker/api/check_username.php", params)
	...
	def get_forum_featured(self, recommend_id: int = 0) -> dict:
		...
		return self._get(
			self.bbs_api, "/api/game_video/recommend_list", params)
	...
	def get_forum_hot(self, tag_id: int = 0) -> dict:
		...
		return self._get(
			self.bbs_api, "/api/game_video/hot_list", params)
	...
	def get_forum_latest(
		...
		return self._get(
			self.bbs_api, "/api/game_video/newest_list", params)
	...
	def get_forum_mine(
		...
		return self._get(
			self.bbs_api, "/api/game_video/personal_list", params)
	...
	def get_unread_notifications(self) -> dict:
		...
		return self._get(
			self.bbs_api, "/api/notification/unread", params)
	...
	def get_comment_notifications(
		...
		return self._get(
			self.bbs_api, "/api/notification/comment_msg_list", params)
	...
	def get_system_notifications(
		...
		return self._get(
			self.bbs_api,
			f"/api/notification/system_msg_list", params)
